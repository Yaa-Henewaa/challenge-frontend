...
const Headphones = () => {
  const headphonesProducts = [
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/8038336/pexels-photo-8038336.jpeg?auto=compress&cs=tinysrgb&w=800",
      category: "headphones",
      isNew: false,
    },
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-black text-white py-24">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-h1 font-bold uppercase">HEADPHONES</h1>
        </div>
      </div>
